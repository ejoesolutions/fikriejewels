...
$config['tables']['products']					= 'ci_products';
$config['tables']['ci_variants']			= 'ci_variants';
$config['tables']['ci_buy_product']		= 'ci_buy_product';
 ...
 */
$config['site_title']                 = "Rich-Jewellery";       // Site Title, example.com
$config['admin_email']                = "donotreply@rich-jewellery.com"; // Admin Email, admin@example.com
