    ...
    <table class="table table-bordered">
      <thead>
        <tr class="text-center">
          ...
          <th width="18%">Maklumat Produk</th>
          <th width="18%">Keterangan</th>
          <!-- <th width="15%">Anggaran Harga <br> Semasa ( RM )</th>
          <th width="15%">Anggaran Harga <br> Dasar ( RM )</th> -->
          <th width="15%">Anggaran Harga ( RM )</th>
        </tr>
      </thead>
      <tbody>
      <tr>
        ...
        <tr>
          ...
          <td style="border-left-color: #ffffff !important;border-bottom-color: #ffffff !important;border-right-color: #ffffff !important; ">
            <label class="float-right">Bayaran Deposit ( RM ) :</label>
          </td>
          <td style="border-left-color: #ffffff !important;border-bottom-color: #ffffff !important;border-right-color: #ffffff !important; ">
