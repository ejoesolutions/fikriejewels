...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-12 col-md-10">
      <?= form_open('booking/add_booking', array('id'=>'addBooking')); ?>

      <div class="card shadow" id="section-to-print">
        <div class="card-body p-5">
          <div class="row mb-5">
            <div class="col-12 text-center mb-4">
              <h3 class="mb-0 text-uppercase">Resit Tempahan Baru</h3>
            </div>
            <div class="col-md-6">
              <p class="small text-dark text-uppercase mb-2">Resit Daripada</p>
          ...
          <table class="table nowrap text-dark" id="example">
            ...
            <tr class="text-center">
              ...
              <th nowrap width="15%">Maklumat Produk</th>
              <th nowrap width="15%">Keterangan</th>
              <th nowrap width="15%">Anggaran Harga Semasa ( RM )</th>
              <th nowrap width="15%">Anggaran Harga Dasar ( RM )</th>
              <th nowrap width="15%">Anggaran Harga Kaunter ( RM )</th>
            </tr>
            </thead>
            <tbody>
          ...
          <div class="float-left">
            <a href="<?= base_url('booking/create_booking') ?>" class="btn mb-3 btn-outline-dark"> <span class="fe fe-arrow-left fe-8"></span> Kembali</a><br>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?= form_open('user/register_cust_new',array('class'=>'form-horizontal','id'=>'')) ?>
...
<script>
  ...
  $('#addBooking').one('submit', function() {
