      ...
      <div class="form-group row justify-content-center">
        ...
        <div class="col-md-5 col-xl-3">
          <select class="form-control" id="choose">
            ...
            <option value="3">Kategori / Status</option>
          </select>
        </div>
      </div>
      ...
      <div id="byCategory" class="form-group row justify-content-center" style="display:none">
        ...
        <div class="col-md-5 col-xl-3">
          <select class="form-control" id="category">
            <option value="" selected>---Pilih---</option>
            <option value="1">Ikat Harga</option>
            <option value="2">Harga Semasa</option>
            <option value="9">Tempahan Baiki</option>
          </select>
        </div>
      </div>

      <div id="byStatus" class="form-group row justify-content-center" style="display:none">
...
<div class="col-md-12">
  <h4 class="page-title" id="tableTitle">Senarai Pesanan</h4>
  <div class="card shadow">
    <div class="card-body">
...
$(document).ready(function(){
  ...
  function trans_table() {
    ...
    $('#queryTable').dataTable({
      ...
      "ajax": {
        url : "<?= base_url('orders/query_list_order'); ?>",
        data: { 
          choose : $("#choose").val(), 
